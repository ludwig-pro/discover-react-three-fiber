...
function useBox(fn, fwdRef) {
  return useBody('Box', fn, args => args ? args.map(x => x / 2) : [0.5, 0.5, 0.5], fwdRef);
}
...
const Provider = typeof window === 'undefined' ? () => null : /*#__PURE__*/lazy(() => import('./Provider-0121eb30.js'));
